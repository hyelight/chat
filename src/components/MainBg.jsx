...
const MainBg = () => {
  return (
    <section className="w-full h-[100vh] top-[90px]" id="home">
      ...
      <div className="flex flex-col items-center h-[90%] justify-center text-[var(--f6-color)]">
        <h3 className="text-5xl font-bold mb-6 text-[]  text-center leading-tight">
          For your{" "}
          <span className="text-[var(--main-green)] main-word-text-shadow">
            healthy
          </span>{" "}
          life
        </h3>
